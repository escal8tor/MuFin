...
--- Write table contents to file in INI format.
---
--- @param iniTable table  Contents to be written
--- @param file     string Path in which to write
---
--- @return boolean ok Status of operation.
